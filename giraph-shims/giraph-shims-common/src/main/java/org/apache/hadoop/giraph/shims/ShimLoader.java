...
public abstract class ShimLoader {
  ...
  static {
    HADOOP_SHIM_CLASSES.put("0.20",
        "org.apache.hadoop.giraph.shims.Hadoop20Shims");
    HADOOP_SHIM_CLASSES.put("0.20S",
        "org.apache.hadoop.giraph.shims.Hadoop20SShims");
    HADOOP_SHIM_CLASSES.put("0.23",
        "org.apache.hadoop.giraph.shims.Hadoop23Shims");
  }
  ...
  public static String getMajorVersion() {
    ...
    // If we are running a security release,
    // we won't have UnixUserGroupInformation
