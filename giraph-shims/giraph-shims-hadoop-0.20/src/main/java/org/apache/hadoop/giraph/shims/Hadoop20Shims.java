...
public class Hadoop20Shims implements HadoopShims {
  ...
  makeTaskAttemptContext(Configuration conf, TaskAttemptID taskAttemptID) {
    org.apache.hadoop.mapreduce.TaskAttemptContext context;
    context = new org.apache.hadoop.mapreduce.TaskAttemptContext(conf, taskAttemptID);
    return context;
  }

  @Override
  public org.apache.hadoop.mapreduce.JobContext
  makeJobContext(Configuration conf, JobID jobID) {
    org.apache.hadoop.mapreduce.JobContext context;
    context = new org.apache.hadoop.mapreduce.JobContext(conf, jobID);
    return context;
  }
